...
# Introducing Energy Meter

Energy Meter is a new startup in the energy industry.
...
At Energy Meter the development team use a story wall or kanban board to keep track of features or "stories" as they are worked on.
...
Energy Meter is a new energy company that uses data to ensure customers are 
